...
async function DEP_getWebviewContent(context, resourcesUri, theme, namespace) {
...
async function DEP_handleDiagramUpdate(document, diagram, webviewPanel) {
...
async function DEP_resolveCustomTextEditor(document, webviewPanel) {
...
async function DEP_saveToNewFile(uri, diagram) {
    var data;
    log(
...
async function DEP_showSaveDialog(defaultName) {
...
function activate(context) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'drakon.newDiagram',
            async function () {
                const defaultName = 'НоваяСхема_'
                + getCurrentDateTimeString();
                const uri = await provider.showSaveDialog(
                    defaultName
                );
                if (!uri)
                return ;
...
DrakonEditorProvider.prototype.getWebviewContent = DEP_getWebviewContent
DrakonEditorProvider.prototype.resolveCustomTextEditor = DEP_resolveCustomTextEditor
DrakonEditorProvider.prototype.handleDiagramUpdate = DEP_handleDiagramUpdate
DrakonEditorProvider.prototype.showSaveDialog = DEP_showSaveDialog
DrakonEditorProvider.prototype.saveToNewFile = DEP_saveToNewFile
